...
BOT_USERNAME = os.environ.get("BOT_USERNAME" ,"karnataka_superbot") 
SUDO=os.environ.get("SUDO",None)
BOT_NAME = os.environ.get("BOT_NAME","Karnataka Superbot")
START_IMG = os.environ.get("START_IMG","https://telegra.ph/file/9cea5c976f27502aaec66.jpg")
...
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","about_shaan")
SUDO=os.environ.get("SUDO",None)
